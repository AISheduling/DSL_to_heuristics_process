...
- 4 метрики: значение целевой функции, число запланированных работ, число итераций (число шагов цикла планировщика (запуски работ + шаги advance_time)), финальное время.
- Информация о бюджете невозобновляемых ресурсов (Case 3).
